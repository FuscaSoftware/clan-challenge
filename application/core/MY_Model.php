...
require_once APPPATH . "/core/traits/MY_Model_Knot_Trait.php";
require_once APPPATH . "/core/traits/MY_Model_CRUD_Trait.php";
use Model_helper_lib as MH;
class MY_Model extends CI_Model
{
    use MY_Model_Trait;
    use MY_Model_Knot_Trait;
    use MY_Model_CRUD_Trait;
}
